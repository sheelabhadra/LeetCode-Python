...
## SOLUTION: Use a stack to store the price and the result. If the top of the stack is lesser than
# the current price, then keep popping from the stack until the top of the stack is greater than the
# current price. At each pop from the stack increment the res by the result.
